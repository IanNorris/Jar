	...
	mounted: function () {
		...
		$(element).daterangepicker({
			...
			ranges: {
				...
				'The last 30 days': [moment().subtract(29, 'days'), moment()],
				'The last 3 months': [moment().subtract(3, 'months'), moment()],
				'The last 6 months': [moment().subtract(6, 'months'), moment()],
				'The last year': [moment().subtract(1, 'year'), moment()],
				'The last two years': [moment().subtract(2, 'year'), moment()],
