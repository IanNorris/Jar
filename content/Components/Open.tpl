		...
		<div class="d-none d-lg-flex col-lg-8 align-items-center ui-bg-cover ui-bg-overlay-container p-4"
			...
			<div class="w-100 text-white px-5">
				...
				<div class="text-large font-weight-light">
					With Jars you&#39;ll always know what you have available to spend. Planning a
						...
						<form class="my-5" v-on:submit.prevent="createNewBudget">
							...
							<div>
								...
								<div class="d-flex justify-content-between align-items-center m-0">
									<div></div>
									<button type="submit" class="btn btn-primary" v-bind:disabled="password != password2">Create</button>
								</div>
							</div>
						</form>
